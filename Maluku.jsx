    ...
    return (
        <div className={`splash-screen`}>
            ...
            <div className="welcome-text">
                ...
                <div className="sub-text">SELAMAT DATANG DI MALUKU</div>
            </div>
...
function Game() {
    ...
    const points = [
        {
            id: 'Gunung Binaiya', x: 450, y: 700, name: 'Gunung Binaiya', color: '#4caf50',
            activities: [
                { name: 'Naik Gunung', duration: 5000, stat: { happiness: +10 }, icon: '⛰' },
                { name: 'Foto-foto', duration: 4000, stat: { happiness: +15, energy: -5 }, icon: '📷' },
                { name: 'Makan Roti', duration: 3000, stat: { food: +10 }, icon: '🍞', item: 'Roti' }
            ]
        },
        {
            id: 'Gong Perdamaian', x: 500, y: 150, name: 'Gong Perdamaian', color: '#2196f3',
            activities: [
        ...
        {
            id: 'Jembatan merah putih', x: 900, y: 205, name: 'Jembatan Merah Putih', color: '#ff9800',
            activities: [
    ...
    return (
        <div className="maluku-container">
            <div className="top-right-controls">
                <button className="maluku-back-button" onClick={() => navigate(-1)}>
                    ← Kembali
                </button>
            ...
            {showRules && (
                <div className="modal-overlay" onClick={() => setShowRules(false)}>
                    <div className="rules-content" onClick={e => e.stopPropagation()}>
                        <h2>📋 Aturan Game - Petualangan Maluku</h2>
