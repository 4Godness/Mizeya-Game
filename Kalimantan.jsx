    ...
    return (
        <div className={`splash-screen`}>
            ...
            <div className="welcome-text">
                ...
                <div className="sub-text">SELAMAT DATANG DI KALIMANTAN</div>
            </div>
...
function Game() {
    ...
    const points = [
        {
            id: 'Sungai Mahakam', x: 450, y: 750, name: 'Gunung Binaiya', color: '#4caf50',
            activities: [
                { name: 'Melihat Pemandangan', duration: 5000, stat: { happiness: +10 }, icon: '🔭' },
        ...
        {
            id: 'IKN', x: 450, y: 420, name: 'IKN', color: '#2196f3',
            activities: [
                { name: 'Kunjungi Museum', duration: 8000, stat: { knowledge: +20, energy: -10 }, icon: '🏛️' },
                { name: 'Belajar Sejarah', duration: 6000, stat: { knowledge: +25, energy: -15 }, icon: '📚', requiredItem: 'Kamera' }
            ]
        },
        {
            id: 'Hutan Kalimantan', x: 1300, y: 370, name: 'Hutan Kalimantan', color: '#ff9800',
            activities: [
                { name: 'Jalan Jalan', duration: 7000, stat: { happiness: +20, energy: -15 }, icon: '🚶‍♂' },
                { name: 'Rekam Video', duration: 5000, stat: { happiness: +10, energy: -5 }, icon: '📹' },
                { name: 'Membersihkan Sampah', duration: 4000, stat: { energy: +10 }, icon: '🧹', item: 'Sapu' }
            ]
        },
    ];
    ...
    return (
        <div className="kalimantan-container">
            <div className="top-right-controls">
                <button className="kalimantan-back-button" onClick={() => navigate(-1)}>
                    ← Kembali
                </button>
            ...
            {showRules && (
                <div className="modal-overlay" onClick={() => setShowRules(false)}>
                    <div className="rules-content" onClick={e => e.stopPropagation()}>
                        <h2>📋 Aturan Game - Petualangan Kalimantan</h2>
