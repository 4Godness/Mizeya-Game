    ...
    return (
        <div className={`splash-screen`}>
            ...
            <div className="welcome-text">
                ...
                <div className="sub-text">SELAMAT DATANG DI SUMATERA</div>
            </div>
...
function Game() {
    ...
    const points = [
        {
            id: 'Jam Gadang', x: 500, y:800, name: 'Jam Gadang', color: '#4caf50',
            activities: [
                { name: 'Beli Oleh-Oleh Khas Sumatera', duration: 5000, stat: { happiness: +10, Pengetahuan: +5 }, icon: '🛍️' },
                { name: 'Foto-foto', duration: 4000, stat: { happiness: +15, energy: -5 }, icon: '📷' },
                { name: 'Membuang Sampah', duration: 3000, stat: { energy: -5 }, icon: '🗑', item: 'Ember' }
            ]
        },
        {
            id: 'Danau Toba', x: 1200, y: 320, name: 'Danau Toba', color: '#2196f3',
            activities: [
                { name: 'Naik Perahu', duration: 8000, stat: { Kebahagiaan: +20, energy: -10 }, icon: '🏛️' },
                { name: 'Tari Tor-Tor', duration: 6000, stat: { Kebahagiaan: +14, energy: -15 }, icon: '💃🏼', requiredItem: 'Menari' },
                { name: 'Makan Mie Gomak', duration: 6000, stat: { Kebahagiaan: +10, energy: -15 }, icon: '🍝', requiredItem: 'Mi Gomak' }
            ]
        },
        {
            id: 'Jembatan Ampera', x: 1100, y: 700, name: 'Jembatan Ampera', color: '#ff9800',
            activities: [
                { name: 'Jalan Jalan', duration: 7000, stat: { happiness: +20, energy: -15 }, icon: '🚶‍♂' },
                { name: 'Foto', duration: 5000, stat: { happiness: +10, energy: -5 }, icon: '📹' },
                { name: 'Naik Perahu', duration: 4000, stat: { energy: -10 }, icon: '🛶', item: 'Perahu' }
            ]
        },
    ];
    ...
    return (
        <div className="sumatera-container">
            <div className="top-right-controls">
                <button className="sumatera-back-button" onClick={() => navigate('/Game')}> ← Kembali</button>
            ...
            {showRules && (
                <div className="modal-overlay" onClick={() => setShowRules(false)}>
                    <div className="rules-content" onClick={e => e.stopPropagation()}>
                        <h2>📋 Aturan Game - Petualangan Sumatera</h2>
