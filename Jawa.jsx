    ...
    return (
        <div className={`splash-screen`}>
            ...
            <div className="welcome-text">
                ...
                <div className="sub-text">SELAMAT DATANG DI JAWA</div>
            </div>
...
function Game() {
    ...
    const points = [
    {
        id: 'Monas',  x: 1150, y: 450, name: 'Monas', color: '#ffc107',
        activities: [
            { name: 'Naik ke Puncak', duration: 5000, stat: { happiness: +15 }, icon: '🏛️' },
            { name: 'Foto dengan Patung', duration: 4000, stat: { happiness: +10, energy: -5 }, icon: '📷' },
            { name: 'Makan Soto Betawi', duration: 3000, stat: { food: +15 }, icon: '🍜', item: 'Soto' }
        ]
    },
    {
        id: 'Borobudur', x: 500, y: 150, name: 'Candi Borobudur', color: '#795548',
        activities: [
            { name: 'Keliling Candi', duration: 8000, stat: { knowledge: +25, energy: -15 }, icon: '🛕' },
            { name: 'Belajar Sejarah', duration: 6000, stat: { knowledge: +30, energy: -10 }, icon: '📚', requiredItem: 'Kamera' }
        ]
    },
    {
        id: 'UMN', x: 450, y: 550, name: 'UMN', color: '#2196f3',
        activities: [
            { name: 'Kuliah', duration: 7000, stat: { knowledge: +20, energy: -20 }, icon: '🎓' },
            { name: 'Nongkrong di libro', duration: 5000, stat: { happiness: +15, energy: +5 }, icon: '☕' },
            { name: 'Makan ayam hainam', duration: 4000, stat: { food: +10 }, icon: '🍢', item: 'Bakso' }
        ]
    },
];
    ...
    return (
        <div className="jawa-container">
            <div className="top-right-controls">
                <button className="jawa-back-button" onClick={() => navigate(-1)}>
                    ← Kembali
                </button>
            ...
            {showRules && (
                <div className="modal-overlay" onClick={() => setShowRules(false)}>
                    <div className="rules-content" onClick={e => e.stopPropagation()}>
                        <h2>📋 Aturan Game - Petualangan Jawa</h2>
